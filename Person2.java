...
public class Person2
{
    ...
    public Person2(String fn, String ln, int ag, String sc, String pg, int yr) {
        firstName = fn; 
        lastName = ln;
        age = ag;
        school = sc;
    ...
    public String toString() {
        if (age == 999 && graduatingYear == 9999 && program == "unknown" && school == "unknown") {
            return firstName+" "+lastName+" is unknown years old, \n\tattends "
