 ...
 * Date: 2/8/24
 * Assignment: Assignment: 3.10.7 Triangle Three For
 * Purpose: Learning and understanding the mechanics of nested for loops. 
 */

import java.util.Scanner;
public class TriangleThreeFor
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Assignment: 3.10.7 Triangle Three For");
        ...
        System.out.println();
        System.out.println("**************************************************");
        System.out.println("Ending Assignment <3.10.7>: Triangle Three For");
    }
}
