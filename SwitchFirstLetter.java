 ...
 * Assignment: 2.8.5 SwitchFirstLetter
...
public class SwitchFirstLetter
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Assignment: 2.8.5 SwitchFirstLetter");
        ...
        for (int i=0;i<5;i++) {
            ...
            System.out.println("The strings "+string1+" and "+string2+ " with the first"+"\n\tletters switched are: "+switchFirstLetter(string1, string2));
        }
